...
<body class="min-h-screen flex items-center justify-center px-4" style="background: linear-gradient(135deg, #e3f2ff 0%, #f6fbff 40%, #ffffff 100%);">
    ...
    <div class="w-full max-w-lg bg-white rounded-3xl shadow-2xl p-8" style="border: none;">
        ...
        <h2 class="text-lg font-semibold text-gray-700 border-b-2 pb-3 mb-6 text-center" style="border-color: #e3f2ff;">
            <i class="fa-solid fa-user-plus mr-1" style="color: #667eea;"></i>
            Đăng ký tài khoản
        </h2>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div>
                ...
                <input id="name"
                       ...
                       class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:border-blue-500 focus:ring focus:ring-blue-100 outline-none @error('name') border-red-500 @enderror">
                @error('name')
            ...
            <div>
                ...
                <input id="email"
                       ...
                       class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:border-blue-500 focus:ring focus:ring-blue-100 outline-none @error('email') border-red-500 @enderror">
                @error('email')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input id="password"
                           ...
                           class="w-full border border-gray-300 rounded-lg px-4 py-2 pr-10 focus:border-blue-500 focus:ring focus:ring-blue-100 outline-none @error('password') border-red-500 @enderror">
                    <button type="button"
