...
@section('title', 'Quản lý loại xét nghiệm')
                            ...
                            <tr class="table-row-hover" style="transition: all 0.2s ease;">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('admin.test-types.edit', $type->id) }}"
                                           class="btn btn-sm btn-warning rounded-pill px-3 shadow-sm"
                                           title="Chỉnh sửa">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('admin.test-types.destroy', $type->id) }}"
                                              method="POST"
                                              class="d-inline">
                                            @csrf
                                            @method('DELETE')
