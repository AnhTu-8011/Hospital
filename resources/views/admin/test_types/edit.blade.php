    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
        <div>
            ...
            <h1 class="h3 mb-0 fw-bold text-dark">
                <i class="fas fa-edit me-2 text-primary"></i>Cập nhật loại xét nghiệm
            </h1>
        </div>
    ...
    <form action="{{ route('admin.test-types.update', $type->id) }}" method="POST">
        ...
        @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ old('name', $type->name) }}" class="form-control rounded-3 border-2" required style="transition: all 0.3s ease;" onfocus="this.style.borderColor='#667eea'; this.style.boxShadow='0 0 0 0.2rem rgba(102, 126, 234, 0.25)';" onblur="this.style.borderColor=''; this.style.boxShadow='';" placeholder="Nhập tên loại xét nghiệm">
        </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="form-control rounded-3 border-2" rows="4" placeholder="Nhập mô tả..." style="transition: all 0.3s ease;" onfocus="this.style.borderColor='#667eea'; this.style.boxShadow='0 0 0 0.2rem rgba(102, 126, 234, 0.25)';" onblur="this.style.borderColor=''; this.style.boxShadow='';">{{ old('description', $type->description) }}</textarea>
        </div>
