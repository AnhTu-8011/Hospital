...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
    <div>
        <p class="text-uppercase text-primary fw-semibold mb-1" style="letter-spacing: .08em; font-size: 0.85rem;">QUẢN LÝ DỊCH VỤ</p>
                                    ...
                                    <div class="d-flex flex-wrap gap-1">
                                        @foreach($service->symptoms->take(3) as $symptom)
                                            <span class="badge bg-info-subtle text-info rounded-pill px-2 py-1 small">
                                                <i class="fas fa-clipboard-pulse me-1"></i>{{ $symptom->symptom_name }}
                                            </span>
                                        @endforeach
