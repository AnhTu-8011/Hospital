            ...
            <form action="{{ route('admin.services.update', $service->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description"
                              ...
                              placeholder="Nhập mô tả gói dịch vụ (mỗi dòng một mục)..."
                              style="transition: all 0.3s ease;"
                              onfocus="this.style.borderColor='#667eea'; this.style.boxShadow='0 0 0 0.2rem rgba(102, 126, 234, 0.25)';"
                              onblur="this.style.borderColor=''; this.style.boxShadow='';">{{ old('description', $service->description) }}</textarea>
                    @php
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number"
                               ...
                               class="form-control rounded-3 border-2 @error('price') is-invalid @enderror"
                               required
                               style="transition: all 0.3s ease;"
                               onfocus="this.style.borderColor='#667eea'; this.style.boxShadow='0 0 0 0.2rem rgba(102, 126, 234, 0.25)';"
                               onblur="this.style.borderColor=''; this.style.boxShadow='';"
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted d-block mt-2">
                        Thêm các triệu chứng mà dịch vụ này có thể điều trị. Hệ thống sẽ sử dụng để gợi ý dịch vụ phù hợp cho bệnh nhân.
                    </small>
                </div>
