            ...
            <form action="{{ route('admin.diseases.update', $disease) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label class="form-label fw-semibold mb-2">
                        ...
                        Tên bệnh <span class="text-danger">*</span>
                    </label>
                    <input type="text"
                           name="name"
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="department_id"
                                class="form-select rounded-3 border-2 @error('department_id') is-invalid @enderror"
                                required
                                style="transition: all 0.3s ease;"
                                onfocus="this.style.borderColor='#667eea'; this.style.boxShadow='0 0 0 0.2rem rgba(102, 126, 234, 0.25)';"
                                onblur="this.style.borderColor=''; this.style.boxShadow='';">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file"
                               name="image"
                               class="form-control rounded-3 border-2 @error('image') is-invalid @enderror"
                               accept="image/*"
                               style="transition: all 0.3s ease;"
                               onfocus="this.style.borderColor='#667eea'; this.style.boxShadow='0 0 0 0.2rem rgba(102, 126, 234, 0.25)';"
                               onblur="this.style.borderColor=''; this.style.boxShadow='';">
                        ...
                        @if($disease->image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/'.$disease->image) }}"
                                     alt="{{ $disease->name }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description"
                              rows="6"
                              class="form-control rounded-3 border-2 @error('description') is-invalid @enderror"
                              style="transition: all 0.3s ease;"
                              onfocus="this.style.borderColor='#667eea'; this.style.boxShadow='0 0 0 0.2rem rgba(102, 126, 234, 0.25)';"
                              onblur="this.style.borderColor=''; this.style.boxShadow='';"
                              placeholder="Nhập mô tả về bệnh">{{ old('description', $disease->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    <label class="form-label fw-semibold mb-2">
                        <i class="fas fa-clipboard-pulse text-primary me-2"></i>
                        Triệu chứng liên quan
                    </label>
                            ...
                            @foreach($oldSymptoms as $sym)
                                <div class="input-group mb-2">
                                    <input type="text"
                                           name="symptoms[]"
                                           value="{{ $sym }}"
                                           class="form-control rounded-3 border-2 symptom-input"
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="{{ route('admin.diseases.index') }}" class="btn btn-lg btn-outline-secondary rounded-pill px-4">
                        Hủy
                    </a>
                </div>
            </form>
