    ...
    <div class="container-fluid">
        ...
        <div class="mt-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="dropdown">
                    <button class="btn btn-light border-0 rounded-pill shadow-sm px-4"
                            type="button"
                            id="chartMenuButton"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3" aria-labelledby="chartMenuButton">
                        <li>
                            <a class="dropdown-item chart-option rounded-2" data-type="daily" href="#">
                                <i class="fas fa-calendar-day me-2"></i>
                                Theo ngày
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item chart-option rounded-2" data-type="monthly" href="#">
                                <i class="fas fa-calendar-alt me-2"></i>
                                Theo tháng
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item chart-option rounded-2" data-type="yearly" href="#">
