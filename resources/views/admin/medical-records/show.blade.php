    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            ...
            <h4 class="fw-bold text-dark mb-0">
                ...
                Hồ sơ #{{ str_pad($medicalRecord->id, 6, '0', STR_PAD_LEFT) }}
            </h4>
        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-2">
                        <strong>Mã bảo hiểm:</strong> {{ $patient->insurance_number ?? '-' }}
                    </p>
                    <p class="mb-0">
            ...
            <div class="card border-0 shadow-sm rounded-4">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-2">
                        ...
                        {{ optional(optional($appointment)->doctor->user ?? null)->name ?? '-' }}
                    </p>
                    <p class="mb-2">
                        <strong>Dịch vụ:</strong>
                        {{ optional(optional($appointment)->service ?? null)->name ?? '-' }}
                    </p>
                    <p class="mb-0">
