                        ...
                        <div class="col-md-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <strong class="text-dark">
                                        @if(optional($patient)->gender === 'male')
                                            Nam
                                        @elseif(optional($patient)->gender === 'female')
                                            Nữ
                                        @else
                                            Không rõ
                                        @endif
                        ...
                        <div class="col-md-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <strong class="text-dark">
                                        {{ optional(optional($appointment->doctor)->user)->name ?? 'Không rõ' }}
                                    </strong>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="badge bg-info-subtle text-info rounded-pill px-3 py-1">
                                        {{ optional($appointment->service)->name ?? 'Không rõ' }}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-light rounded-4 p-4 mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="diagnosis"
                                      name="diagnosis"
                                      class="form-control rounded-3 border-2 bg-light"
                                      rows="3"
                                      placeholder="Nhập chuẩn đoán..."
                                      readonly
                                      disabled>{{ old('diagnosis', optional($record)->diagnosis ?? '') }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="doctor_conclusion"
                                      ...
                                      class="form-control rounded-3 border-2 bg-light"
                                      rows="3"
                                      placeholder="Nhập kết luận bác sĩ..."
                                      readonly
                                      disabled>{{ old('doctor_conclusion', optional($record)->doctor_conclusion ?? '') }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @else
                                ...
                                @if(is_string($prescription))
                                    <textarea class="form-control rounded-3 border-2 bg-light"
                                              rows="4"
                                              readonly
                                              disabled>{!! nl2br(e($prescription)) !!}</textarea>
                                @elseif(is_array($prescription) && count($prescription))
                                    {{-- Prescription Array Table --}}
                                    <div class="table-responsive">
                                        <table class="table table-sm table-bordered mb-0">
                                            <thead class="table-light">
                                                <tr>
