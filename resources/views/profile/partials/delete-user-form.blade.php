                ...
                <form method="post" action="{{ route('profile.destroy') }}" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-4">
                            ...
                            {{-- Hiển thị lỗi không dùng Breeze --}}
...
<style>
    ...
    .modal-content { border: none; border-radius: .5rem; box-shadow: 0 10px 30px rgba(0,0,0,.15); }
    .modal-header { border-top-left-radius: .5rem; border-top-right-radius: .5rem; padding: 1.25rem 1.5rem; }
