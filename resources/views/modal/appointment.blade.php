...
<section class="container py-4">
    ...
    <div class="text-center mb-5">
        <p class="text-uppercase text-primary fw-semibold mb-2" style="letter-spacing: .08em; font-size: 0.85rem;">
            ĐẶT LỊCH KHÁM
        </p>
    ...
    <div class="row g-4">
        {{-- Service Details Card (Left Side) --}}
                    ...
                    <div class="card-body p-4">
                            ...
                            <select name="service_id"
                                ...
                                @foreach($services as $service)
                                    <option value="{{ $service->id }}"
                                            data-department-id="{{ $service->department_id }}"
                        ...
                        <div class="d-grid gap-2 mt-4">
                            @auth
                                ...
                                @else
                                    <button type="button"
                                            class="btn btn-lg rounded-pill shadow-sm bg-secondary text-white fw-bold"
                                            disabled>
                                        <i class="fas fa-lock me-2"></i>
                                        Thanh toán VNPay (Chưa liên kết hồ sơ)
                                    </button>
                                @endif
                            @else
                                <a href="{{ route('login') }}"
